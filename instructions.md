...
This particular instance covers **AI governance writ large** — technical AI safety and alignment, governance and regulatory theory, AI-specific policy (the EU AI Act, US executive actions, the UK and other AI Safety Institutes, China's regulatory architecture, multilateral processes), and the pedagogy of teaching this material across disciplines. The goal is to support an interdisciplinary academic program: aggregating what its faculty know and debate, and making the material queryable for curriculum decisions.
...
Example: *"What historical regulatory analogues — nuclear, pharmaceutical, aviation — fit AI governance best, and where do they break? What readings should a course on this assign?"*
...
- Coverage gaps — claims or definitions developed in one domain (e.g., technical safety) with no connection to the others (governance theory, AI policy, pedagogy); these are opportunities for synthesis
...
## How a wiki run plays out: an illustrative history

_The narrative below is from a **prior instance** of this wiki engine — a personal research project on LLM role-playing and sociology of role-taking. It is preserved here as a worked example of how the workflow unfolds in practice, since this AI-governance instance is still at the scaffolding stage. Substitute "Persona Selection Model" with whatever your first source happens to be and the cadence will be similar._
...
**This instance.** The AI-governance wiki was scaffolded on 2026-04-30: project-particulars realigned, overview rewritten around four domains in dialogue (technical safety, governance theory, AI policy, pedagogy) and five live tensions, StartHere.md created. No raw sources ingested yet. See `wiki/log.md` for the running operation history.
